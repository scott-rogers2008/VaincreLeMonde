## Habits to complement the goal of [making this into a product](/goals/current/production_goal.md) by Christmas:
(using the [habit goal form](/goals/habit_goal_form.docx))

### Motivation:
Similar to the motivation in the [associated achivement goal](/goals/current/production_goal.md)
